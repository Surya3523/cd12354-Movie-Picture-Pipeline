...
# Track latest release for the given Kubernetes version
...
resource "aws_eks_node_group" "main" {
  ...
  release_version = nonsensitive(
    data.aws_ssm_parameter.eks_ami_release_version.value
  )
...
# Create the GitHub Actions IAM user.
# The inline IAM policy was removed because the VocLabs role
# does not have permission to perform iam:PutUserPolicy.
